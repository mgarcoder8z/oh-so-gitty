...
def register():
    ...
    # if first_name contains symbol(s) or numberic value(s),
        ...
        flash('First name cannot contain symbol(s) or number(s)!', 'error')
    else:
        flash("Success!")
    ...
    # if first_name contains symbol(s) or numberic value(s),
        ...
        flash('Last name cannot contain symbol(s) or number(s)!', 'error')
    else:
        flash("Success!")
    ...
    if len(session['confirm']) < 1:
        flash("Confirmation cannot be blank!", 'error')
